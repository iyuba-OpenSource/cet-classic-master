...
public class NewTypeSectionAAnswerOp extends DatabaseService {
    ...
    public void resetAnswer() {
        ...
        String sqlStrA = "update  newtype_answera6 set your_answer = null";
        importDatabase.openDatabase().execSQL(sqlStrA);
        String sqlStrB = "update  newtype_answerb6 set your_answer = null";
        importDatabase.openDatabase().execSQL(sqlStrB);
        String sqlStrC = "update  newtype_answerc6 set your_answer = null";
        importDatabase.openDatabase().execSQL(sqlStrC);
    }
