...
public class ConfirmDialog extends Dialog {
    ...
    protected void initView() {
        ...
        ImageView word_collect = dialog_confirm.findViewById(com.iyuba.biblelib.R.id.word_collect);
        word_collect.setVisibility(View.GONE);


        card.searchWord(keyWord);
        card.findViewById(com.iyuba.biblelib.R.id.word_close).setOnClickListener(new View.OnClickListener() {
            @Override
