...
public class HomeCourseListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(com.iyuba.biblelib.R.layout.microclass_item_common_mobclasslist, null);
            viewHolder = new ViewHolder();
            viewHolder.title = convertView.findViewById(com.iyuba.biblelib.R.id.coursePack_title);
            viewHolder.tvclassNum = convertView.findViewById(com.iyuba.biblelib.R.id.tv_courseNum1);
            viewHolder.courseNum = convertView.findViewById(com.iyuba.biblelib.R.id.coursePack_courseNum);
            viewHolder.content = convertView.findViewById(com.iyuba.biblelib.R.id.coursePackDesc_content);
            viewHolder.pic = convertView.findViewById(com.iyuba.biblelib.R.id.coursePack_pic);
            viewHolder.oldPrice = convertView.findViewById(com.iyuba.biblelib.R.id.tv_coursePack_oldprice);
            viewHolder.newPrice = convertView.findViewById(com.iyuba.biblelib.R.id.tv_coursePack_newprice);
            viewHolder.viewCount = convertView.findViewById(com.iyuba.biblelib.R.id.tv_coursePack_viewCount);
        ...
        GitHubImageLoader.Instace(mContext).setPic(allPicUrl, viewHolder.pic, com.iyuba.configation.R.drawable.nearby_no_icon);
