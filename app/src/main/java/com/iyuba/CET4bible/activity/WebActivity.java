...
public class WebActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.iyuba.biblelib.R.layout.lib_web);
        progressIndictor = findViewById(com.iyuba.biblelib.R.id.pb_progress_indictor);
        backButton = findViewById(com.iyuba.biblelib.R.id.lib_button_back);
        textView = findViewById(com.iyuba.biblelib.R.id.web_buyiyubi_title);
        web = findViewById(com.iyuba.biblelib.R.id.webView);
        textView.setText(Constant.APPName);
        textView.setTextColor(getResources().getColor(com.iyuba.biblelib.R.color.trainingcamp_white));
