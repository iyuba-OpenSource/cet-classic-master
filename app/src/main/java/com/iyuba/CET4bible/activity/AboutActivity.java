...
public class AboutActivity extends BasisActivity implements AppUpdateCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companyName = findView(R.id.company_name);
        //注释掉默认爱语吧，打开万云天
        companyName.setText(Constant.COMPANY_NAME + "科技有限公司");
        mContext = this;
            ...
            try {
                ...
                Dialog dialog = new AlertDialog.Builder(mContext)
                        ...
                        .setTitle(getResources().getString(
                                com.iyuba.biblelib.R.string.alert_title))
        ...
        announcer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dialog = new AlertDialog.Builder(mContext)
                        ...
                        .setNeutralButton(getResources().getString(com.iyuba.biblelib.R.string.alert_btn_ok),
    ...
    public void appUpdateSave(String version_code, String newAppNetworkUrl) {
        ...
        alert.setButton(AlertDialog.BUTTON_POSITIVE,
                ...
                (dialog, which) -> handler.sendEmptyMessage(0));
