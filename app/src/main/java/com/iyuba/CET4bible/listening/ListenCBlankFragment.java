...
public class ListenCBlankFragment extends Fragment implements
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                ...
                previous.setBackgroundResource(com.iyuba.biblelib.R.drawable.previous_question);
            } else if (msg.what == 2) {
                previous.setBackgroundResource(com.iyuba.biblelib.R.drawable.un_previous_question);
            } else if (msg.what == 3) {
                next.setBackgroundResource(com.iyuba.biblelib.R.drawable.next_question);
            } else if (msg.what == 4) {
                next.setBackgroundResource(com.iyuba.biblelib.R.drawable.next_question);
            }
        }
    ...
    private void setContent() {
        ...
        sbBuffer.append("<font color='")
                ...
                .append("'>");
        sbBuffer.append(mContext.getString(com.iyuba.biblelib.R.string.answer)).append(":")
                .append("</font>&emsp;");
        ...
        if (blank.keyword1 != null && !blank.keyword1.equals("null")) {
            sbBuffer.append("<font color='")
                    .append(getResources().getColor(com.iyuba.configation.R.color.app_color))
                    .append("'>");
            sbBuffer.append(mContext.getString(com.iyuba.biblelib.R.string.keys)).append(
                    "</font>&emsp;");
