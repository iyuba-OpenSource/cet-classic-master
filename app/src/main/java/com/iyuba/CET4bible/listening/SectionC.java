...
//        }
    ...
    private void controlVideo() {
        ...
        extendedPlayer.setOnPreparedListener(new OnPreparedListener() {
            @Override
        ...
        extendedPlayer.setOnBufferingUpdateListener(new OnBufferingUpdateListener() {
            @Override
        ...
        extendedPlayer.setOnCompletionListener(new OnCompletionListener() {
            @Override
    ...
    public void onBackPressed() {
        if (backPressed) {
            ...
            alert.setButton(AlertDialog.BUTTON_POSITIVE, getResources()
                            .getString(com.iyuba.biblelib.R.string.alert_btn_ok),
                    new DialogInterface.OnClickListener() {
                        @Override
