...
public class FavoriteAdapter extends BaseRecyclerViewAdapter<FavoriteAdapter.Holder> {
    ...
    public FavoriteAdapter(Context mContext, List list) {
        ...
        if (BuildConfig.isCET4) {
            ...
            yearImageMap.put("2023061702", R.drawable.ic_2017061702);
            yearImageMap.put("2023061701", R.drawable.ic_2017061702);
            yearImageMap.put("2022121002", R.drawable.ic_2017061702);

            yearImageMap.put("2022121001", R.drawable.ic_2017061702);
            yearImageMap.put("2022091101", R.drawable.ic_2017061702);
            yearImageMap.put("2022061801", R.drawable.ic_2017061702);
            yearImageMap.put("2021121802", R.drawable.ic_2017061702);

            yearImageMap.put("2021121801", R.drawable.ic_2017061702);
            yearImageMap.put("2021061202", R.drawable.ic_2017061702);
            yearImageMap.put("2021061201", R.drawable.ic_2017061702);
            yearImageMap.put("2020121202", R.drawable.ic_2017061702);


            yearImageMap.put("2020121201", R.drawable.ic_2017061702);
            yearImageMap.put("2020091901", R.drawable.ic_2017061702);
            yearImageMap.put("2020071101", R.drawable.ic_2017061702);
            yearImageMap.put("2019121402", R.drawable.ic_2017061702);
            yearImageMap.put("2019121401", R.drawable.ic_2017061702);

            yearImageMap.put("2019061502", R.drawable.ic_2017061702);
            yearImageMap.put("2019061501", R.drawable.ic_2017061702);
            yearImageMap.put("2018121502", R.drawable.ic_2017061702);
            yearImageMap.put("2018121501", R.drawable.ic_2017061702);
            yearImageMap.put("2018061602", R.drawable.ic_2017061702);
            yearImageMap.put("2018061601", R.drawable.ic_2017061702);
    ...
    public void onBindViewHolder(final Holder curViewHolder, final int position) {
        ...
        if (mList.get(position) instanceof NativeResponse) {
            ...
            Glide.with(mContext).load(response.getMainImageUrl())
                    .error(com.iyuba.configation.R.drawable.nearby_no_icon2)
                    .placeholder(com.iyuba.configation.R.drawable.nearby_no_icon2)
        ...
        String path = ExamDataUtil.getImageUrl(examListOp.findImageByID(test));
        Glide.with(mContext).load(path).into(curViewHolder.iv_year);
        ...
        curViewHolder.functionView.setVisibility(View.GONE);
        curViewHolder.functionImage.setBackgroundResource(com.iyuba.biblelib.R.drawable.go);
