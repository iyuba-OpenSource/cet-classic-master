    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (finish) {
            ...
            if (cetAnswer.yourAnswer.equals(cetAnswer.rightAnswer)) {
                viewHolder.your.setBackgroundResource(com.iyuba.biblelib.R.drawable.item_select);
            } else {
                ...
                if (cetAnswer.yourAnswer.equals("")) {
                    viewHolder.your.setText(com.iyuba.biblelib.R.string.no_answer);
                }
            }
        } else {
            viewHolder.right.setText(com.iyuba.biblelib.R.string.secret);
            if (cetAnswer.yourAnswer.equals("")) {
                viewHolder.your.setText(com.iyuba.biblelib.R.string.no_answer);
            }
        }
