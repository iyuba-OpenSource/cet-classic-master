...
public class Constant {
    ...
    public static final String YOUDAO_VIDEO_ID = "a0ffd83740c31d1965ebc73aa5560482";
    ...
    public static String IMOOC_TYPE_DESC;
    ...
    public static final String PROTOCOL_URL_HEADER = "http://iuserspeech.iyuba.cn:9001/api/protocol.jsp?apptype=";
    /**
     * 用户协议和隐私政策链接
     */
    public static final String PRI_URL = "https://ai.iyuba.cn/api/protocolpri.jsp?apptype=";
    public static final String USE_URL = "https://ai.iyuba.cn/api/protocoluse.jsp?apptype=";
//    public static final String COMPANY_NAME = "济南万云天教育";//华为公司不一样
    public static final String COMPANY_NAME = "北京爱语吧";//华为公司不一样
