...
public class ListenRankListAdapter extends BaseAdapter {
    ...
    private List<ListenRankingInfoBean.DataDTO> rankUserList = new ArrayList<>();
    private LayoutInflater mInflater;
    private Pattern p;
    private Matcher m;

    public ListenRankListAdapter(Context mContext, List<ListenRankingInfoBean.DataDTO> rankUserList) {
    ...
    public void resetList(List<ListenRankingInfoBean.DataDTO> list) {
        rankUserList.clear();
    ...
    public void addList(List<ListenRankingInfoBean.DataDTO> list) {
        rankUserList.addAll(list);
        notifyDataSetChanged();
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ListenRankingInfoBean.DataDTO ru = rankUserList.get(position);
