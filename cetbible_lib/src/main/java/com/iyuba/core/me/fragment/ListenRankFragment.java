...
public class ListenRankFragment extends Fragment {
    ...
    private List<ListenRankingInfoBean.DataDTO> rankUsers = new ArrayList<>();
    private ListenRankingInfoBean.DataDTO champion;
...
//        tvRightRate = root.findViewById(R.id.tv_test_right_rate);
        ...
        tr_tv_num = root.findViewById(R.id.tr_tv_num);

        tr_tv_word_count = root.findViewById(R.id.tr_tv_word_count);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_listen_rank, container, false);
        findViews(rootView);
    ...
    private void requestRankData() {
        ...
        Http.get(url, new HttpCallback() {
            ...
            public void onSucceed(Call call, String response) {
                ...
                tr_tv_num.setText("文章总数" + bean.getTotalEssay());
                tr_tv_word_count.setText("单词总数：" + bean.getTotalWord());
