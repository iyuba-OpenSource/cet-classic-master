...
import com.iyuba.biblelib.BuildConfig;
...
public class PayOrderActivity extends Activity {
    ...
    private Response.ErrorListener mOrderErrorListener = error -> {
    ...
    Handler alipayHandler = new Handler(new Handler.Callback() {
        @Override
...
//        mWeiXinKey = "wx9436ec54e9b65561";
    ...
    private void findView() {
        orderInfo = findViewById(R.id.order_info_content);
    ...
    private void payByAlipay(String body, String subject) {
        ...
        VolleyUtil.getInstance(PayOrderActivity.this).add(orderRequest);
    }
    ...
    private void payByWeiXin() {
        ...
        VolleyUtil.getInstance(PayOrderActivity.this).add(request);
    }
