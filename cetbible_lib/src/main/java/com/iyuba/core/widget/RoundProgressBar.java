...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        roundColor = mTypedArray.getColor(
                R.styleable.circleProgressBar_circleColor, getResources().getColor(com.iyuba.configation.R.color.darkgray));
        roundProgressColor = mTypedArray.getColor(
                R.styleable.circleProgressBar_circleProgressColor, getResources().getColor(com.iyuba.base.R.color.colorPrimary));
        textColor = mTypedArray.getColor(
                R.styleable.circleProgressBar_textColor, getResources().getColor(com.iyuba.base.R.color.colorPrimary));
        textSize = mTypedArray.getDimension(
                R.styleable.circleProgressBar_textSize, DisplayUtil.sp2px(context, 10));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (textIsDisplayable && percent != 0 && style == STROKE) {
            ...
            canvas.drawText(String.valueOf(percent), centre, centre + distance, paint);
        }
        paint.reset();
        paint.setStrokeWidth(DisplayUtil.dip2px(getContext(), roundWidth));
