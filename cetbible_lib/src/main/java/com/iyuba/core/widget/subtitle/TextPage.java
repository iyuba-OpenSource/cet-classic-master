                ...
                if (isCanSelect) {
                    ...
                    if (endTime - initTime > 500) {
                        ...
                        if (selectText.length() > 0) {
                            ...
                            if (selectText.contains(")") && !selectText.contains("(")) {

                                break;
                            }
                            if (selectText.equals("1.") || selectText.equals("2.") || selectText.equals("3.")
                                    || selectText.equals("4.") || selectText.equals("5.") || selectText.equals("6.")
                                    || selectText.equals("7.") || selectText.equals("8.") || selectText.equals("9.")
                                    || selectText.equals("10.")) {
                                break;
                            }
