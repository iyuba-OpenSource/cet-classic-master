        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (index <= mTotal) {
                    ...
                    if (index == mTotal) {
                        btn_next.setText(getResources().getString(com.iyuba.biblelib.R.string.complete));//完成
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!NetWorkState.isConnectingToInternet()) {
                    CustomToast.showToast(mContext, com.iyuba.biblelib.R.string.alert_net_content, 1000);
                } else {
                    mTestRecord.TestTime = deviceInfo.getCurrentTime();
