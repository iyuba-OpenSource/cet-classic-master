...
//        String appkey = Constant.APP_CONSTANT.MOB_APPKEY();//appkey不对
//        String secret = Constant.APP_CONSTANT.MOB_APP_SECRET();
//        MobSDK.init(getApplicationContext(), appkey, secret);
