...
public class WebActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.iyuba.biblelib.R.layout.lib_web_ability);
        progressIndictor = findViewById(com.iyuba.biblelib.R.id.pb_progress_indictor);
        backButton = findViewById(com.iyuba.biblelib.R.id.iv_title_back);
        textView = findViewById(com.iyuba.biblelib.R.id.tv_nav_title);
