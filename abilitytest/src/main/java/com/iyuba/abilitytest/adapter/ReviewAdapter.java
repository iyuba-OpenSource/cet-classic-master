...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if (mCurrent < position) {
            holder.tv_title_num.setTextColor(mContext.getResources().getColor(com.iyuba.configation.R.color.white));
        } else {
            holder.tv_title_num.setTextColor(mContext.getResources().getColor(com.iyuba.configation.R.color.green));
        }
